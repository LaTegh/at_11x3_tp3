/*
Copyright 2025 sekigon (@sekigon-gonnoc)
...
#pragma message("Auto-KDK Trackpad support is enabled for this configuration.")
#else
#pragma message("Auto-KDK Trackpad support is disabled for this configuration.")
